...
Begin VB.Form frmMiscReceipt 
   Caption         =   "General Receipt"
   ClientHeight    =   4320
   ClientLeft      =   165
   ClientTop       =   855
   ClientWidth     =   6180
   Icon            =   "frmMiscReceipt.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   4320
   ScaleWidth      =   6180
   ...
   End
End
Attribute VB_Name = "frmMiscReceipt"
...
Option Explicit
'************************************************************************************************
'* This form is used to generate a miscellaneous receipt.  It takes down information about a person
'* and then calls the new receipt function to generate the receipt.
'*
'************************************************************************************************
...
'************************************************************************************************
'* Saves the person's information to the database and calls the new receipt form.
'************************************************************************************************
...
frmNewReciept.cboReason.ListIndex = 4
frmNewReciept.intType = 5
frmNewReciept.intNumber = 0
frmPCHS_Main.Show
frmNewReciept.Show
Unload Me
