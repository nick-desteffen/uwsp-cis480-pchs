...
Begin VB.Form frmAdoptPeople 
   ...
   End
End
Attribute VB_Name = "frmAdoptPeople"
...
If lstPeopleNum.Text <> "" Then
    frmNewAdoption.intPersonNum = lstPeopleNum.Text
    Unload Me
Else
...
lblName.Caption = frmNewAdoption.txtFname.Text & " " & frmNewAdoption.txtLname.Text
...
Set rstSearch = objConnection.Execute("SELECT * FROM PERSON WHERE PERSON_FNAME = '" & frmNewAdoption.txtFname.Text & "' AND PERSON_LNAME = '" & frmNewAdoption.txtLname.Text & "'")
